...
public class ToolBoxGridRecyclerAdapter extends BaseRecycleViewAdapter {


    public ToolBoxGridRecyclerAdapter(Context context, List<?> data) {
    ...
    protected RecyclerView.ViewHolder baseCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mLayoutInflater.inflate(R.layout.item_tool_box_grid, parent, false);
