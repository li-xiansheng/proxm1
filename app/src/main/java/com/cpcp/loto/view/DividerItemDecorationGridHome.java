...
public class DividerItemDecorationGridHome extends RecyclerView.ItemDecoration {
    private Drawable mDividerDarwable;
    private int mDividerHight = 1;
    private Paint mColorPaint;
    public final int[] ATRRS = new int[]{android.R.attr.listDivider};

    public DividerItemDecorationGridHome(Context context) {
     ...
     */
    public DividerItemDecorationGridHome(Context context, int dividerHight, int dividerColor) {
        this(context);
     ...
     */
    public DividerItemDecorationGridHome(Context context, int dividerHight, Drawable dividerDrawable) {
        this(context);
        mDividerHight = dividerHight;
