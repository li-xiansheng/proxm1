...
public class DividerItemDecorationGrid extends RecyclerView.ItemDecoration {
     ...
     */
    public DividerItemDecorationGrid(Context context, int dividerHight, int dividerColor) {
        this(context);
     ...
     */
    public DividerItemDecorationGrid(Context context, int dividerHight, Drawable dividerDrawable) {
        this(context);
        mDividerHight = dividerHight;
