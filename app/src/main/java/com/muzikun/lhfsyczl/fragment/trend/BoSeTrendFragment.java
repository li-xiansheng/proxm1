...
import com.muzikun.lhfsyczl.adapter.BoseTrendRecyclerAdapter;
...
public class BoSeTrendFragment extends BasePullRefreshFragment {


    private List<TrendAnalysisEntity> mList;
    private String title = "";
    private boolean isFirst = true;//是否第一次加载
    private BoseTrendRecyclerAdapter mBaseRecycleViewAdapter;
    ...
    protected void initView() {
        ...
        mBaseRecycleViewAdapter = new BoseTrendRecyclerAdapter(mContext, mList);
