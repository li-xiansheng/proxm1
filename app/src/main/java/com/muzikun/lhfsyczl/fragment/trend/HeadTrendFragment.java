...
import com.muzikun.lhfsyczl.adapter.HeadTrendRecyclerAdapter;
...
public class HeadTrendFragment extends BasePullRefreshFragment {


    private List<TrendAnalysisEntity> mList;
    private String title = "";
    private boolean isFirst = true;//是否第一次加载
    private HeadTrendRecyclerAdapter mBaseRecycleViewAdapter;
    ...
    protected void initView() {
        ...
        mBaseRecycleViewAdapter = new HeadTrendRecyclerAdapter(mContext, mList);
