...
import com.muzikun.lhfsyczl.adapter.WuXingTrendRecyclerAdapter;
...
public class WuXingTrendFragment extends BasePullRefreshFragment {


    private List<TrendAnalysisEntity> mList;
    private String title = "";
    private boolean isFirst = true;//是否第一次加载
    private WuXingTrendRecyclerAdapter mBaseRecycleViewAdapter;
    ...
    protected void initView() {
        ...
        mBaseRecycleViewAdapter = new WuXingTrendRecyclerAdapter(mContext, mList);
